...
async function main() {
  ...
  const instrumentData = [
    // ══════ КРИПТОВАЛЮТЫ ══════
    { name: "Биткоин", slug: "btcf", ticker: "BTCF", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BA", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BA", tradingViewSymbol: null, dataSource: "moex", dataTicker: "BTCF", description: "Фьючерс на биткоин", categorySlug: "crypto", instrumentType: "crypto" },
