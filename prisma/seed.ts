...
async function main() {
  ...
  const instrumentData = [
    ...
    // ══════ КРИПТОВАЛЮТЫ (Bybit) ══════
    { name: "Bitcoin", slug: "btcusdt", ticker: "BTCUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/BTCUSDT", externalUrl: "https://www.bybit.com/trade/usdt/BTCUSDT", tradingViewSymbol: "BYBIT:BTCUSDT", dataSource: "bybit", dataTicker: "BTCUSDT", description: "Bitcoin / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    ...
    { name: "Solana", slug: "solusdt", ticker: "SOLUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/SOLUSDT", externalUrl: "https://www.bybit.com/trade/usdt/SOLUSDT", tradingViewSymbol: "BYBIT:SOLUSDT", dataSource: "bybit", dataTicker: "SOLUSDT", description: "Solana / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    ...
    { name: "BNB", slug: "bnbusdt", ticker: "BNBUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/BNBUSDT", externalUrl: "https://www.bybit.com/trade/usdt/BNBUSDT", tradingViewSymbol: "BYBIT:BNBUSDT", dataSource: "bybit", dataTicker: "BNBUSDT", description: "BNB / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Dogecoin", slug: "dogeusdt", ticker: "DOGEUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/DOGEUSDT", externalUrl: "https://www.bybit.com/trade/usdt/DOGEUSDT", tradingViewSymbol: "BYBIT:DOGEUSDT", dataSource: "bybit", dataTicker: "DOGEUSDT", description: "Dogecoin / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Cardano", slug: "adausdt", ticker: "ADAUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/ADAUSDT", externalUrl: "https://www.bybit.com/trade/usdt/ADAUSDT", tradingViewSymbol: "BYBIT:ADAUSDT", dataSource: "bybit", dataTicker: "ADAUSDT", description: "Cardano / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Avalanche", slug: "avaxusdt", ticker: "AVAXUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/AVAXUSDT", externalUrl: "https://www.bybit.com/trade/usdt/AVAXUSDT", tradingViewSymbol: "BYBIT:AVAXUSDT", dataSource: "bybit", dataTicker: "AVAXUSDT", description: "Avalanche / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Polkadot", slug: "dotusdt", ticker: "DOTUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/DOTUSDT", externalUrl: "https://www.bybit.com/trade/usdt/DOTUSDT", tradingViewSymbol: "BYBIT:DOTUSDT", dataSource: "bybit", dataTicker: "DOTUSDT", description: "Polkadot / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Chainlink", slug: "linkusdt", ticker: "LINKUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/LINKUSDT", externalUrl: "https://www.bybit.com/trade/usdt/LINKUSDT", tradingViewSymbol: "BYBIT:LINKUSDT", dataSource: "bybit", dataTicker: "LINKUSDT", description: "Chainlink / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Litecoin", slug: "ltcusdt", ticker: "LTCUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/LTCUSDT", externalUrl: "https://www.bybit.com/trade/usdt/LTCUSDT", tradingViewSymbol: "BYBIT:LTCUSDT", dataSource: "bybit", dataTicker: "LTCUSDT", description: "Litecoin / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Polygon", slug: "maticusdt", ticker: "MATICUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/MATICUSDT", externalUrl: "https://www.bybit.com/trade/usdt/MATICUSDT", tradingViewSymbol: "BYBIT:MATICUSDT", dataSource: "bybit", dataTicker: "MATICUSDT", description: "Polygon / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Toncoin", slug: "tonusdt", ticker: "TONUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/TONUSDT", externalUrl: "https://www.bybit.com/trade/usdt/TONUSDT", tradingViewSymbol: "BYBIT:TONUSDT", dataSource: "bybit", dataTicker: "TONUSDT", description: "Toncoin / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Sui", slug: "suiusdt", ticker: "SUIUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/SUIUSDT", externalUrl: "https://www.bybit.com/trade/usdt/SUIUSDT", tradingViewSymbol: "BYBIT:SUIUSDT", dataSource: "bybit", dataTicker: "SUIUSDT", description: "Sui / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    { name: "Pepe", slug: "pepeusdt", ticker: "PEPEUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/PEPEUSDT", externalUrl: "https://www.bybit.com/trade/usdt/PEPEUSDT", tradingViewSymbol: "BYBIT:PEPEUSDT", dataSource: "bybit", dataTicker: "PEPEUSDT", description: "Pepe / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    ...
    // ══════ СЫРЬЁ (MOEX FORTS) ══════
    { name: "Золото", slug: "gold", ticker: "GOLD", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=GOLD", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=GOLD", tradingViewSymbol: "MOEX:GOLD1!", dataSource: "moex", dataTicker: "GOLD", description: "Фьючерс на золото", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Серебро", slug: "silv", ticker: "SILV", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SILV", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SILV", tradingViewSymbol: "MOEX:SILV1!", dataSource: "moex", dataTicker: "SILV", description: "Фьючерс на серебро", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Платина", slug: "plt", ticker: "PLT", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PT", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PT", tradingViewSymbol: "MOEX:PLT1!", dataSource: "moex", dataTicker: "PLT", description: "Фьючерс на платину", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Палладий", slug: "pld", ticker: "PLD", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PD", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PD", tradingViewSymbol: "MOEX:PLD1!", dataSource: "moex", dataTicker: "PLD", description: "Фьючерс на палладий", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Медь", slug: "cu", ticker: "CU", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CU", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CU", tradingViewSymbol: "MOEX:CU1!", dataSource: "moex", dataTicker: "CU", description: "Фьючерс на медь", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Нефть Brent", slug: "br", ticker: "BR", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BR", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BR", tradingViewSymbol: "MOEX:BR1!", dataSource: "moex", dataTicker: "BR", description: "Фьючерс на нефть Brent", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Природный газ", slug: "ng", ticker: "NG", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NG", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NG", tradingViewSymbol: "MOEX:NG1!", dataSource: "moex", dataTicker: "NG", description: "Фьючерс на природный газ", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Пшеница", slug: "wheat", ticker: "WHEAT", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=W4", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=W4", tradingViewSymbol: "MOEX:W41!", dataSource: "moex", dataTicker: "WHEAT", description: "Фьючерс на пшеницу", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Сахар", slug: "sugar", ticker: "SUGAR", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SA", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SA", tradingViewSymbol: "MOEX:SA1!", dataSource: "moex", dataTicker: "SUGAR", description: "Фьючерс на сахар", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Какао", slug: "cocoa", ticker: "COCOA", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CC", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CC", tradingViewSymbol: "MOEX:CC1!", dataSource: "moex", dataTicker: "COCOA", description: "Фьючерс на какао", categorySlug: "commodity-futures", instrumentType: "futures" },

    // ══════ ВАЛЮТНЫЕ ФЬЮЧЕРСЫ (MOEX) ══════
    { name: "Доллар/Рубль (Si)", slug: "si", ticker: "Si", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Si", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Si", tradingViewSymbol: "MOEX:SI1!", dataSource: "moex", dataTicker: "Si", description: "Фьючерс на доллар/рубль", categorySlug: "currency-futures", instrumentType: "currency" },
    { name: "Евро/Рубль (Eu)", slug: "eu", ticker: "Eu", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Eu", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Eu", tradingViewSymbol: "MOEX:EU1!", dataSource: "moex", dataTicker: "Eu", description: "Фьючерс на евро/рубль", categorySlug: "currency-futures", instrumentType: "currency" },
    { name: "Юань/Рубль (CR)", slug: "cny", ticker: "CR", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CR", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CR", tradingViewSymbol: "MOEX:CR1!", dataSource: "moex", dataTicker: "CR", description: "Фьючерс на юань/рубль", categorySlug: "currency-futures", instrumentType: "currency" },

    // ══════ ФЬЮЧЕРСЫ НА ИНДЕКСЫ (MOEX) ══════
    { name: "Индекс МосБиржи (MIX)", slug: "imoex", ticker: "MIX", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=MX", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=MX", tradingViewSymbol: "MOEX:MX1!", dataSource: "moex", dataTicker: "MIX", description: "Вечный фьючерс на индекс МосБиржи", categorySlug: "index-futures", instrumentType: "futures" },
    ...
    { name: "NASDAQ 100", slug: "nasd", ticker: "NASD", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NA", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NA", tradingViewSymbol: "MOEX:NA1!", dataSource: "moex", dataTicker: "NASD", description: "Фьючерс на NASDAQ 100", categorySlug: "index-futures", instrumentType: "futures" },
    { name: "S&P 500", slug: "spx", ticker: "SPYF", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SF", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SF", tradingViewSymbol: "MOEX:SF1!", dataSource: "moex", dataTicker: "SPYF", description: "Фьючерс на S&P 500", categorySlug: "index-futures", instrumentType: "futures" },
  ...
  for (const oldSlug of ["stocks-us", "stocks-ru", "commodities", "currencies", "moex-futures"]) {
    ...
    if (oldCat) {
      ...
      if (remaining === 0) {
        ...
        console.log(`Old '${oldSlug}' category deleted`);
      } else {
        console.log(`Warning: ${remaining} instruments still in ${oldSlug}`);
      }
    }
  }
