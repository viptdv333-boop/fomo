...
async function main() {
  ...
  const assetData = [
    ...
    // Акции РФ
    { name: "Сбербанк", slug: "sberbank", categorySlug: "ru-stocks", sortOrder: 1, description: "Крупнейший банк России. Лидер по капитализации на MOEX" },
    { name: "Газпром", slug: "gazprom", categorySlug: "ru-stocks", sortOrder: 2, description: "Газовая монополия. Крупнейший производитель природного газа в мире" },
    { name: "ЛУКОЙЛ", slug: "lukoil", categorySlug: "ru-stocks", sortOrder: 3, description: "Частная нефтяная компания. Одна из крупнейших в мире" },
    { name: "Яндекс", slug: "yandex", categorySlug: "ru-stocks", sortOrder: 4, description: "IT-гигант России. Поиск, такси, доставка, облачные сервисы" },
    { name: "Роснефть", slug: "rosneft", categorySlug: "ru-stocks", sortOrder: 5, description: "Государственная нефтяная компания, крупнейшая в России" },
    { name: "Норникель", slug: "norilsk-nickel", categorySlug: "ru-stocks", sortOrder: 6, description: "Крупнейший производитель никеля и палладия в мире" },
    { name: "Новатэк", slug: "novatek", categorySlug: "ru-stocks", sortOrder: 7, description: "Частная газовая компания. Лидер по производству СПГ в России" },
    { name: "Полюс", slug: "polyus", categorySlug: "ru-stocks", sortOrder: 8, description: "Крупнейший золотодобытчик России и один из крупнейших в мире" },
    { name: "Магнит", slug: "magnit", categorySlug: "ru-stocks", sortOrder: 9, description: "Вторая по выручке розничная сеть России" },
    { name: "ВТБ", slug: "vtb", categorySlug: "ru-stocks", sortOrder: 10, description: "Второй по величине банк России, государственный" },
    { name: "Тинькофф", slug: "tinkoff", categorySlug: "ru-stocks", sortOrder: 11, description: "Онлайн-банк и брокер. Крупнейший цифровой банк в России" },
    { name: "МТС", slug: "mts", categorySlug: "ru-stocks", sortOrder: 12, description: "Крупнейший мобильный оператор России. Экосистема услуг" },
    { name: "Аэрофлот", slug: "aeroflot", categorySlug: "ru-stocks", sortOrder: 13, description: "Национальный авиаперевозчик России" },
    { name: "Алроса", slug: "alrosa", categorySlug: "ru-stocks", sortOrder: 14, description: "Крупнейшая алмазодобывающая компания в мире" },
    { name: "НЛМК", slug: "nlmk", categorySlug: "ru-stocks", sortOrder: 15, description: "Новолипецкий металлургический комбинат. Один из крупнейших в России" },

    // Акции США (NYSE/NASDAQ)
    { name: "Apple", slug: "apple", categorySlug: "us-stocks", sortOrder: 1, description: "Самая дорогая компания мира. iPhone, Mac, сервисы" },
    { name: "Tesla", slug: "tesla", categorySlug: "us-stocks", sortOrder: 2, description: "Электромобили и чистая энергетика. Илон Маск" },
    { name: "Microsoft", slug: "microsoft", categorySlug: "us-stocks", sortOrder: 3, description: "Windows, Azure, Office 365. Инвестор в OpenAI" },
    { name: "Amazon", slug: "amazon", categorySlug: "us-stocks", sortOrder: 4, description: "E-commerce и облачные вычисления (AWS)" },
    { name: "Google", slug: "google", categorySlug: "us-stocks", sortOrder: 5, description: "Alphabet Inc. Поиск, YouTube, Android, облачные сервисы" },
    { name: "Nvidia", slug: "nvidia", categorySlug: "us-stocks", sortOrder: 6, description: "Лидер GPU и AI-чипов. Основной бенефициар бума ИИ" },
    { name: "Meta", slug: "meta", categorySlug: "us-stocks", sortOrder: 7, description: "Facebook, Instagram, WhatsApp. Метавселенная" },
    { name: "Netflix", slug: "netflix", categorySlug: "us-stocks", sortOrder: 8, description: "Стриминг видеоконтента. 250+ млн подписчиков" },
    { name: "AMD", slug: "amd", categorySlug: "us-stocks", sortOrder: 9, description: "Процессоры и видеокарты. Конкурент Intel и Nvidia" },
    { name: "Intel", slug: "intel", categorySlug: "us-stocks", sortOrder: 10, description: "Крупнейший производитель процессоров для ПК и серверов" },
    { name: "JPMorgan", slug: "jpmorgan", categorySlug: "us-stocks", sortOrder: 11, description: "Крупнейший банк США по активам" },
    { name: "Berkshire Hathaway", slug: "berkshire", categorySlug: "us-stocks", sortOrder: 12, description: "Холдинг Уоррена Баффетта. Страхование и инвестиции" },
    { name: "Visa", slug: "visa", categorySlug: "us-stocks", sortOrder: 13, description: "Крупнейшая платёжная система в мире" },
    { name: "Coca-Cola", slug: "coca-cola", categorySlug: "us-stocks", sortOrder: 14, description: "Производитель напитков. Дивидендный аристократ" },
    { name: "Disney", slug: "disney", categorySlug: "us-stocks", sortOrder: 15, description: "Развлечения, парки, стриминг Disney+" },

    // Мировые индексы
    { name: "Индекс MOEX", slug: "moex-index", categorySlug: "indices", sortOrder: 1, description: "Главный индекс Московской биржи. 50 крупнейших компаний РФ" },
    { name: "РТС", slug: "rts-index", categorySlug: "indices", sortOrder: 2, description: "Долларовый индекс российского рынка" },
    { name: "S&P 500", slug: "sp500", categorySlug: "indices", sortOrder: 3, description: "500 крупнейших компаний США. Главный мировой бенчмарк" },
    { name: "Nasdaq 100", slug: "nasdaq100", categorySlug: "indices", sortOrder: 4, description: "100 крупнейших технологических компаний США" },
    { name: "Dow Jones", slug: "dow-jones", categorySlug: "indices", sortOrder: 5, description: "30 крупнейших промышленных компаний США. Старейший индекс" },
    { name: "Russell 2000", slug: "russell2000", categorySlug: "indices", sortOrder: 6, description: "2000 малых компаний США. Индикатор внутренней экономики" },
    { name: "Hang Seng", slug: "hang-seng", categorySlug: "indices", sortOrder: 7, description: "Главный индекс Гонконгской биржи" },
    { name: "HSCEI", slug: "hscei", categorySlug: "indices", sortOrder: 8, description: "Индекс китайских компаний на Гонконгской бирже" },
    { name: "DAX 40", slug: "dax40", categorySlug: "indices", sortOrder: 9, description: "40 крупнейших компаний Германии. Главный индекс Европы" },
    { name: "FTSE 100", slug: "ftse100", categorySlug: "indices", sortOrder: 10, description: "100 крупнейших компаний Лондонской биржи" },
    { name: "Nikkei 225", slug: "nikkei225", categorySlug: "indices", sortOrder: 11, description: "225 крупнейших компаний Японии. Токийская биржа" },

    // Валюта
    { name: "Рубль/Доллар", slug: "usd-rub", categorySlug: "currencies", sortOrder: 1, description: "Основная валютная пара для российских трейдеров" },
    { name: "Рубль/Юань", slug: "cny-rub", categorySlug: "currencies", sortOrder: 2, description: "Юань стал второй валютой торгов на MOEX после доллара" },
    { name: "Евро/Доллар", slug: "eur-usd", categorySlug: "currencies", sortOrder: 3, description: "Самая торгуемая валютная пара в мире" },

    // Криптовалюты
    { name: "Bitcoin", slug: "bitcoin", categorySlug: "crypto", sortOrder: 1, description: "Первая и крупнейшая криптовалюта. Цифровое золото" },
    { name: "Ethereum", slug: "ethereum", categorySlug: "crypto", sortOrder: 2, description: "Платформа смарт-контрактов. Основа DeFi и NFT" },
    { name: "Solana", slug: "solana", categorySlug: "crypto", sortOrder: 3, description: "Быстрый блокчейн. 65K транзакций/сек. Конкурент Ethereum" },
    { name: "XRP", slug: "xrp", categorySlug: "crypto", sortOrder: 4, description: "Ripple. Быстрые международные переводы" },
    { name: "BNB", slug: "bnb", categorySlug: "crypto", sortOrder: 5, description: "Токен Binance. Крупнейшей криптобиржи в мире" },
    { name: "Dogecoin", slug: "dogecoin", categorySlug: "crypto", sortOrder: 6, description: "Мем-монета. Поддержка Илона Маска" },
    { name: "Cardano", slug: "cardano", categorySlug: "crypto", sortOrder: 7, description: "Научный подход к блокчейну. Proof-of-Stake" },
    { name: "Avalanche", slug: "avalanche", categorySlug: "crypto", sortOrder: 8, description: "Быстрый блокчейн с субсекундным финалити" },
    { name: "Polkadot", slug: "polkadot", categorySlug: "crypto", sortOrder: 9, description: "Мультичейн протокол. Связывает разные блокчейны" },
    { name: "Chainlink", slug: "chainlink", categorySlug: "crypto", sortOrder: 10, description: "Оракулы для смарт-контрактов. Связь блокчейна с реальным миром" },
    { name: "Litecoin", slug: "litecoin", categorySlug: "crypto", sortOrder: 11, description: "Цифровое серебро. Быстрая альтернатива Bitcoin" },
    { name: "Polygon", slug: "polygon", categorySlug: "crypto", sortOrder: 12, description: "L2-решение для Ethereum. Низкие комиссии" },
    { name: "Toncoin", slug: "toncoin", categorySlug: "crypto", sortOrder: 13, description: "Блокчейн Telegram. Быстрые микроплатежи" },
    { name: "Sui", slug: "sui-crypto", categorySlug: "crypto", sortOrder: 14, description: "Новый L1 блокчейн от экс-Meta. Move язык" },
    { name: "Pepe", slug: "pepe", categorySlug: "crypto", sortOrder: 15, description: "Мем-токен на Ethereum. Волатильный спекулятивный актив" },
  ];
  ...
  const instrumentData = [
    ...
    // ══════ КРИПТОВАЛЮТЫ (Bybit) ══════
    { assetSlug: "bitcoin", name: "Bitcoin (Bybit)", slug: "btcusdt", ticker: "BTCUSDT", exchange: "Bybit", exchangeSlug: "bybit", exchangeUrl: "https://www.bybit.com/trade/usdt/BTCUSDT", externalUrl: "https://www.bybit.com/trade/usdt/BTCUSDT", tradingViewSymbol: "BYBIT:BTCUSDT", dataSource: "bybit", dataTicker: "BTCUSDT", description: "Bitcoin / USDT", categorySlug: "crypto", instrumentType: "crypto" },
    ...
    { assetSlug: null, name: "Евро/Рубль (Eu)", slug: "eu", ticker: "Eu", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Eu", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=Eu", tradingViewSymbol: "MOEX:EU1!", dataSource: "moex", dataTicker: "Eu", description: "Фьючерс на евро/рубль", categorySlug: "currencies", instrumentType: "currency" },
    { assetSlug: "eur-usd", name: "EUR/USD (спот)", slug: "eurusd-spot", ticker: "EURUSD", exchange: "FOREX", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "FX:EURUSD", dataSource: "fmp", dataTicker: "EURUSD", description: "Евро к доллару — основная валютная пара", categorySlug: "currencies", instrumentType: "spot" },
    ...
    // ══════ АКЦИИ США (NYSE/NASDAQ) ══════
    { assetSlug: "apple", name: "Apple Inc", slug: "aapl", ticker: "AAPL", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:AAPL", dataSource: "fmp", dataTicker: "AAPL", description: "Apple Inc — технологическая компания", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "tesla", name: "Tesla Inc", slug: "tsla", ticker: "TSLA", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:TSLA", dataSource: "fmp", dataTicker: "TSLA", description: "Tesla Inc — электромобили и энергетика", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "microsoft", name: "Microsoft Corp", slug: "msft", ticker: "MSFT", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:MSFT", dataSource: "fmp", dataTicker: "MSFT", description: "Microsoft Corporation", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "amazon", name: "Amazon.com Inc", slug: "amzn", ticker: "AMZN", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:AMZN", dataSource: "fmp", dataTicker: "AMZN", description: "Amazon.com Inc", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "google", name: "Alphabet Inc", slug: "googl", ticker: "GOOGL", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:GOOGL", dataSource: "fmp", dataTicker: "GOOGL", description: "Alphabet Inc (Google)", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "nvidia", name: "NVIDIA Corp", slug: "nvda", ticker: "NVDA", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:NVDA", dataSource: "fmp", dataTicker: "NVDA", description: "NVIDIA Corporation — GPU и AI", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "meta", name: "Meta Platforms", slug: "meta", ticker: "META", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:META", dataSource: "fmp", dataTicker: "META", description: "Meta Platforms (Facebook)", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "netflix", name: "Netflix Inc", slug: "nflx", ticker: "NFLX", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:NFLX", dataSource: "fmp", dataTicker: "NFLX", description: "Netflix Inc — стриминг", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "amd", name: "AMD", slug: "amd", ticker: "AMD", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:AMD", dataSource: "fmp", dataTicker: "AMD", description: "Advanced Micro Devices", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "intel", name: "Intel Corp", slug: "intc", ticker: "INTC", exchange: "NASDAQ", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:INTC", dataSource: "fmp", dataTicker: "INTC", description: "Intel Corporation", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "jpmorgan", name: "JPMorgan Chase", slug: "jpm", ticker: "JPM", exchange: "NYSE", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NYSE:JPM", dataSource: "fmp", dataTicker: "JPM", description: "JPMorgan Chase & Co", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "berkshire", name: "Berkshire Hathaway", slug: "brk-b", ticker: "BRK.B", exchange: "NYSE", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NYSE:BRK.B", dataSource: "fmp", dataTicker: "BRK-B", description: "Berkshire Hathaway (Warren Buffett)", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "visa", name: "Visa Inc", slug: "v", ticker: "V", exchange: "NYSE", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NYSE:V", dataSource: "fmp", dataTicker: "V", description: "Visa Inc — платёжная система", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "coca-cola", name: "Coca-Cola Co", slug: "ko", ticker: "KO", exchange: "NYSE", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NYSE:KO", dataSource: "fmp", dataTicker: "KO", description: "The Coca-Cola Company", categorySlug: "us-stocks", instrumentType: "stock" },
    { assetSlug: "disney", name: "Walt Disney Co", slug: "dis", ticker: "DIS", exchange: "NYSE", exchangeSlug: "nyse", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NYSE:DIS", dataSource: "fmp", dataTicker: "DIS", description: "The Walt Disney Company", categorySlug: "us-stocks", instrumentType: "stock" },
    ...
    // ══════ СПОТ ИНДЕКСЫ ══════
    { assetSlug: "sp500", name: "S&P 500 (спот)", slug: "spx-spot", ticker: "SPX", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "SP:SPX", dataSource: "fmp", dataTicker: "^GSPC", description: "Индекс S&P 500 — спотовое значение", categorySlug: "indices", instrumentType: "spot" },
    { assetSlug: "nasdaq100", name: "Nasdaq 100 (спот)", slug: "ndx-spot", ticker: "NDX", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "NASDAQ:NDX", dataSource: "fmp", dataTicker: "^NDX", description: "Индекс Nasdaq 100 — спотовое значение", categorySlug: "indices", instrumentType: "spot" },
    ...
    { assetSlug: "ftse100", name: "FTSE 100 (спот)", slug: "ftse100-spot", ticker: "FTSE", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "FTSE:UKX", dataSource: "fmp", dataTicker: "^FTSE", description: "FTSE 100 Index — спотовое значение", categorySlug: "indices", instrumentType: "spot" },
    { assetSlug: "dax40", name: "DAX 40 (спот)", slug: "dax-spot", ticker: "DAX", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "XETR:DAX", dataSource: "fmp", dataTicker: "^GDAXI", description: "DAX 40 Index — спотовое значение", categorySlug: "indices", instrumentType: "spot" },
    { assetSlug: "nikkei225", name: "Nikkei 225 (спот)", slug: "nikkei-spot", ticker: "NI225", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:NI225", dataSource: "fmp", dataTicker: "^N225", description: "Nikkei 225 Index — спотовое значение", categorySlug: "indices", instrumentType: "spot" },

    // ══════ СПОТ СЫРЬЁ ══════
    { assetSlug: "oil", name: "Brent (спот)", slug: "brent-spot", ticker: "BRENT", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:UKOIL", dataSource: "fmp", dataTicker: "BRTUSD", description: "Нефть Brent — спотовая цена", categorySlug: "commodities", instrumentType: "spot" },
    { assetSlug: "oil", name: "WTI (спот)", slug: "wti-spot", ticker: "WTI", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:USOIL", dataSource: "fmp", dataTicker: "WTIUSD", description: "Нефть WTI — спотовая цена", categorySlug: "commodities", instrumentType: "spot" },
    { assetSlug: "gold", name: "Золото (спот)", slug: "gold-spot", ticker: "XAUUSD", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:GOLD", dataSource: "fmp", dataTicker: "XAUUSD", description: "Золото — спотовая цена (XAU/USD)", categorySlug: "metals", instrumentType: "spot" },
    { assetSlug: "silver", name: "Серебро (спот)", slug: "silver-spot", ticker: "XAGUSD", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:SILVER", dataSource: "fmp", dataTicker: "XAGUSD", description: "Серебро — спотовая цена (XAG/USD)", categorySlug: "metals", instrumentType: "spot" },
    { assetSlug: "gas", name: "Природный газ (спот)", slug: "natgas-spot", ticker: "NATGAS", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:NATGAS", dataSource: "fmp", dataTicker: "NGUSD", description: "Природный газ — спотовая цена", categorySlug: "commodities", instrumentType: "spot" },

    // Споты металлов (недостающие)
    { assetSlug: "platinum", name: "Платина (спот)", slug: "platinum-spot", ticker: "XPTUSD", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:PLATINUM", dataSource: "fmp", dataTicker: "XPTUSD", description: "Платина — спотовая цена", categorySlug: "metals", instrumentType: "spot" },
    { assetSlug: "palladium", name: "Палладий (спот)", slug: "palladium-spot", ticker: "XPDUSD", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:PALLADIUM", dataSource: "fmp", dataTicker: "XPDUSD", description: "Палладий — спотовая цена", categorySlug: "metals", instrumentType: "spot" },
    { assetSlug: "copper", name: "Медь (спот)", slug: "copper-spot", ticker: "XCUUSD", exchange: "SPOT", exchangeSlug: "spot", exchangeUrl: null, externalUrl: null, tradingViewSymbol: "TVC:COPPER", dataSource: "fmp", dataTicker: "XCUUSD", description: "Медь — спотовая цена", categorySlug: "metals", instrumentType: "spot" },
