...
async function main() {
  ...
  const instrumentData = [
    ...
    { name: "Серебро (MOEX)", slug: "silv", ticker: "SILV", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SILV", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SILV", tradingViewSymbol: null, dataSource: "moex", dataTicker: "SILV", description: "Фьючерс на серебро (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Платина (MOEX)", slug: "plt", ticker: "PLT", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PT", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PT", tradingViewSymbol: null, dataSource: "moex", dataTicker: "PLT", description: "Фьючерс на платину (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Палладий (MOEX)", slug: "pld", ticker: "PLD", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PD", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=PD", tradingViewSymbol: null, dataSource: "moex", dataTicker: "PLD", description: "Фьючерс на палладий (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Медь (MOEX)", slug: "cu", ticker: "CU", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CU", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CU", tradingViewSymbol: null, dataSource: "moex", dataTicker: "CU", description: "Фьючерс на медь (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Нефть Brent (MOEX)", slug: "br", ticker: "BR", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BR", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=BR", tradingViewSymbol: null, dataSource: "moex", dataTicker: "BR", description: "Фьючерс на нефть Brent (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Природный газ (MOEX)", slug: "ng", ticker: "NG", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NG", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NG", tradingViewSymbol: null, dataSource: "moex", dataTicker: "NG", description: "Фьючерс на природный газ (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Пшеница (MOEX)", slug: "wheat", ticker: "WHEAT", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=W4", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=W4", tradingViewSymbol: null, dataSource: "moex", dataTicker: "WHEAT", description: "Фьючерс на пшеницу (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Сахар (MOEX)", slug: "sugar", ticker: "SUGAR", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SA", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SA", tradingViewSymbol: null, dataSource: "moex", dataTicker: "SUGAR", description: "Фьючерс на сахар (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    { name: "Какао (MOEX)", slug: "cocoa", ticker: "COCOA", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CC", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=CC", tradingViewSymbol: null, dataSource: "moex", dataTicker: "COCOA", description: "Фьючерс на какао (MOEX)", categorySlug: "commodity-futures", instrumentType: "futures" },
    ...
    { name: "NASDAQ 100 (MOEX)", slug: "nasd", ticker: "NASD", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NA", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=NA", tradingViewSymbol: null, dataSource: "moex", dataTicker: "NASD", description: "Фьючерс на NASDAQ 100 (MOEX)", categorySlug: "index-futures", instrumentType: "futures" },
    { name: "S&P 500 (MOEX)", slug: "spx", ticker: "SPYF", exchange: "MOEX", exchangeSlug: "moex", exchangeUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SF", externalUrl: "https://www.moex.com/ru/derivatives/contracts.aspx?search=SF", tradingViewSymbol: null, dataSource: "moex", dataTicker: "SPYF", description: "Фьючерс на S&P 500 (MOEX)", categorySlug: "index-futures", instrumentType: "futures" },
